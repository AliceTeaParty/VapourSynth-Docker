...
if variant == "generic":
    ...
    print(f"VapourSynth API {vs.__api_version__.api_major} runtime verification passed for {variant}")
else:
    print(f"VapourSynth API {vs.__api_version__.api_major} package verification passed for {variant}")
PY
